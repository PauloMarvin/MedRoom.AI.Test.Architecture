...
class TestTextProcessorUtils:
    ...
    def test_remove_sites(self):
        sample_string = self.sample_sentence
        ...
        assert TextProcessorUtils.remove_sites(
            sample_string,
        ) == expected_string
    ...
    def test_remove_punctuation(self):
        ...
        expected_string = (
            'Olá Esta é uma string de exemplo com algumas pontuações Será que elas serão removidas '
            'também há links como https://www.google.com.br e www.youtube.com.br e emoticons como 😀 '
            '😍 😠 😡'
        )

        assert TextProcessorUtils.remove_punctuation(
            sample_string,
        ) == expected_string
    ...
    def test_remove_stopwords(self):
        ...
        expected_string = (
            'Olá ! string pontuações ! Será serão removidas ? há links https://www.google.com.br '
            'www.youtube.com.br emoticons 😀 😍 😠 😡'
        )
        assert TextProcessorUtils.remove_stopwords(
            sample_string,
        ) == expected_string
    ...
    def test_lemmatization(self):
        ...
        assert TextProcessorUtils.lemmatization(
            sample_string,
        ) == expected_string
    ...
    def test_replace_matches(self):
        ...
        assert TextProcessorUtils.replace_matches(
            sample_string, patterns_data,
        ) == expected_string
